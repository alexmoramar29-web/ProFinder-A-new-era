...
// Basada exactamente en el mockup "Landing Page - Master Header"
// ============================================================
          ...
          {[
            {
              ...
              step:  '01',
              title: 'Look for professionals',
              desc:  'Search through our curated marketplace of professionals using advanced filters for skills, experience, and location.',
              cta:   'Explore Search',
            },
            {
              icon:  'person-circle-outline' as const,
              step:  '02',
              title: 'Read their profiles',
              desc:  'Dive deep into verified portfolio, client testimonials, and technical assessment results for every single candidate.',
              cta:   'View Sample',
            },
            {
              ...
              desc:  'Sync with their calendar and book a virtual meeting directly through our platform in just a few clicks.',
              cta:   'Book Now',
            },
          ].map((s, i) => (
